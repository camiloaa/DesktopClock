...
package com.better.alarmclock;

import com.better.deskclock.AlarmClock;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (AppWidgetManager.ACTION_APPWIDGET_UPDATE.equals(action)) {
            RemoteViews views = new RemoteViews(context.getPackageName(),
                    com.better.deskclock.R.layout.analog_appwidget);

            views.setOnClickPendingIntent(com.better.deskclock.R.id.analog_appwidget,
