...
public final class Alarm implements Parcelable {
    ...
    public static class Columns implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =
                Uri.parse("content://com.better.deskclock/alarm");
    ...
    public String getLabelOrDefault(Context context) {
        if (label == null || label.length() == 0) {
            return context.getString(com.better.deskclock.R.string.default_label);
        }
        return label;
    }
    ...
    static final class DaysOfWeek {
        ...
        public String toString(Context context, boolean showNever) {
            ...
            if (mDays == 0) {
                return showNever ?
                        context.getText(com.better.deskclock.R.string.never).toString() : "";
            }

            // every day
            if (mDays == 0x7f) {
                return context.getText(com.better.deskclock.R.string.every_day).toString();
            }
            ...
            for (int i = 0; i < 7; i++) {
                if ((mDays & (1 << i)) != 0) {
                    ...
                    if (dayCount > 0) ret.append(
                            context.getText(com.better.deskclock.R.string.day_concat));
                }
            }
            return ret.toString();
        }
