...
public class DeskClock extends Activity {
    ...
    private static final String ACTION_MIDNIGHT = "com.better.deskclock.MIDNIGHT";
    ...
    private static final String DOCK_SETTINGS_ACTION = "com.better.settings.DOCK_SETTINGS";
